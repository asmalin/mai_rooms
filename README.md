# Mai rooms - это веб-приложение и telegram-бот, созданные для упрощения просмотра расписания по аудитории и бронирования свободных Московского авиационного института.
